...
const AddTicket = () => {
    ...
    const [reportedDateDisplay, setReportedDateDisplay] = useState(new Date().toDateString());
    const [dueDateDisplay, setDueDateDisplay] = useState(new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toDateString());
