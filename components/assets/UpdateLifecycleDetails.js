...
function UpdateLifecycleDetails({ onSubmitSuccess, assetDetails, initialData = {} }) {
    const [serviceDate, setServiceDate] = useState(new Date(assetDetails.inServiceDate));
    const [showDatePicker, setShowDatePicker] = useState(false);
    const [displayDate, setDisplayDate] = useState('');

    const [serviceOdometer, setServiceOdometer] = useState(assetDetails.inServiceOdometer);
    const [serviceLifeMonths, setServiceLifeMonths] = useState(assetDetails.estimatedServiceLifeInMonths);
    const [serviceLifeMeters, setServiceLifeMeters] = useState(assetDetails.estimatedServiceLifeInMeters);
    const [resaleValue, setResaleValue] = useState(assetDetails.estimatedResaleValue);
    ...
    const validate = () => {
        const newErrors = {};
        if (!serviceDate) newErrors.serviceDate = 'In-Service Date is required';
            ...
            <View style={styles.section}>
                ...
                <View style={styles.sectionContent}>
                    <TextInput
                        ...
                        value={serviceDate.toDateString()}
                        editable={false}
                        mode="outlined"
                        theme={inputTheme}
                        style={styles.input}
                        outlineColor={!!errors.serviceDate && (touched.serviceDate || touched.submit) ? 'red' : '#000'}
                        activeOutlineColor={!!errors.serviceDate && (touched.serviceDate || touched.submit) ? 'red' : '#0acf97'}
                    ...
                    {!!errors.serviceDate && (touched.serviceDate || touched.submit) && (
                    ...
                    <TextInput
                        ...
                        mode="outlined"
                        value={serviceOdometer.toString()}
                        onChangeText={text => {
            ...
            <View style={styles.section}>
                ...
                <View style={styles.sectionContent}>
                    <TextInput
                        ...
                        value={serviceLifeMonths.toString()}
                        onChangeText={text => {
                    ...
                    <TextInput
                        ...
                        mode="outlined"
                        keyboardType="numeric"
                        value={serviceLifeMeters.toString()}
                        onChangeText={text => {
...
export default UpdateLifecycleDetails;
